<x-translation-organizer::layouts.modal>
    ...
    <style type="text/css">
        ...
        #laravel-translation-organizer-modal #translation-on-page-stop,
        #laravel-translation-organizer-modal #translation-on-page-start,
        #laravel-translation-organizer-modal #translation-stop,
        #laravel-translation-organizer-modal #translation-start,
    ...
    <div class="overlay-wrapper" aria-labelledby="slide-over-title" role="dialog" aria-modal="true"
            ...
            <div class="translation-block">
                <div class="tb-header">
                    ...
                    @if($isTranslationEnable)
                        ...
                        @if($isPageTranslationEnable)
                            <button onclick="toggleTranslationOnPage('disable')" id="translation-on-page-stop">
                                Stop On Page
                            </button>
                        @else
                            <button onclick="toggleTranslationOnPage('enable')" id="translation-on-page-start">
                                Show On Page
                            </button>
                        @endif
                    ...
                    @else
                    <button onclick="toggleTranslation('enable')" id="translation-start">
                        Start Translation
                    </button>
                    @endif
                </div>
    ...
    <script>
        ...
        function toggleTranslationOnPage(value) {
            fetch(toggleTranslationOnPageURL, {
                method: 'POST',
