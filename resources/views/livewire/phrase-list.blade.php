                            ...
                            <div class="flex items-center hover:bg-gray-50 cursor-pointer relative group">
                                ...
                                <div class="relative py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <div class="flex gap-4">
                                        <a href="{{ route('translation_organizer.phrases.show', ['translation' => $phrase->translation, 'phrase' => $phrase]) }}" class="text-gray-400 hover:text-violet-700 relative z-50">
                                ...
                                <a href="{{ route('translation_organizer.phrases.show', ['translation' => $phrase->translation, 'phrase' => $phrase]) }}" class="absolute inset-0 z-10"></a>
                            </div>
                        @endforeach
                    </div>
                </div>
