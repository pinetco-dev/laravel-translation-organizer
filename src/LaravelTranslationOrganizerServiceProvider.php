...
class LaravelTranslationOrganizerServiceProvider extends PackageServiceProvider
{
    ...
    {
        Livewire::component('translations-organizer::phrase-form', PhraseForm::class);
        Livewire::component('translations-organizer::source-phrase', SourcePhrase::class);
        Livewire::component('translations-organizer::translations-list', TranslationsList::class);
        Livewire::component('translations-organizer::export-translations', ExportTranslations::class);
        Livewire::component('translations-organizer::create-source-key-modal', CreateSourceKey::class);
        Livewire::component('translations-organizer::create-translation-modal', CreateTranslation::class);
    }
